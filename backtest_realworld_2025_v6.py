"""
Backtest Real-World Test 2025-2026 with V6 Models
Train on all data until Dec 31, 2024
Test on Jan 1, 2025 - Today (Mar 18, 2026)

V6 IMPROVEMENTS:
- 57 features (41 V5 selected + 16 V6 new)
- K-Fold CV trained models
- Conservative hyperparameters (max_depth=5, high regularization)
...
def run_backtest_v6(crypto, timeframe_key):
    ...
    print(f"Model: V6 (K-Fold CV, 57 features, conservative hyperparameters)")
    print('='*80)

    # Load V6 pre-trained model
    model_path = f"./training/models/xgboost_v6/{crypto['cryptoId']}_{timeframe_key}_xgboost_v6.pkl"
...
def main():
    print("\n" + "="*80)
    print("REAL-WORLD BACKTEST 2025-2026 - V6 MODELS")
    print("="*80)
    ...
    print(f"Models: V6 (K-Fold CV, 57 features, conservative hyperparameters)")
    print("="*80)
    ...
    # Final summary
    print("\n" + "="*80)
    print("FINAL SUMMARY - REAL WORLD TEST V6")
    print("="*80)
    ...
    # Save results
    with open('realworld_backtest_2025_v6_results.json', 'w') as f:
        json_results = []
        for r in results:
            json_r = r.copy()
    ...
    print(f"\n[OK] V6 Results saved to: realworld_backtest_2025_v6_results.json")
    print("="*80)
